							...
							<div class="col-sm-12">
								<div class="fileinput fileinput-new" data-provides="fileinput">
									<div class="fileinput-new thumbnail" style="width: 350px; height: <?php echo (int)(350 * PRODUCT_IMAGE_HEIGHT / PRODUCT_IMAGE_WIDTH) ?>px;" data-trigger="fileinput">
										<img src="https://via.placeholder.com/350x<?php echo (int)(350 * PRODUCT_IMAGE_HEIGHT / PRODUCT_IMAGE_WIDTH) ?>" alt="...">
									</div>
		...
		methods: {
			save() {
				...
				if (validator) {
					...
					formData.append('view_count', this.product.view_count == null ? '' : this.product.view_count);
					...
					axios({
							method: 'POST',
							url: '<?php echo base_url() ?>admin/product/insert',
							headers: {
						...
						this.on("removedfile", (file) => {
							axios({
								...
								.then((response) => {
									...
									vm.product.image_ids.pop(image_id);
