					...
					<form id="form-main" role="form" class="form-horizontal form-groups-bordered">
						...
						<div class="row form-group">
							<div class="col-xs-12" style="display: flex; justify-content: center;">
								<a class="btn btn-default btn-sm" href="<?php echo base_url() ?>admin/post" style="margin-right: 10px; font-size: 12px;">Trở về</a>
	...
	var app = new Vue({
		...
		methods: {
			...
			save() {
				...
				formData.append('type', this.post.type == null ? '' : this.post.type);
				...
				axios({
						method: 'POST',
						url: '<?php echo base_url() ?>admin/post/update',
						headers: {
					...
					.then((response) => {
						...
						window.location.replace("<?php echo base_url() ?>admin/post/" + this.post.type);
					})
					.catch((response) => {
