						...
						<div class="row form-group">
							...
							<div class="col-sm-12">
								<div class="fileinput fileinput-new" data-provides="fileinput">
									<div class="fileinput-new thumbnail" style="width: 350px; height: <?php echo (int)(350 * PRODUCT_CATEGORY_IMAGE_HEIGHT / PRODUCT_CATEGORY_IMAGE_WIDTH) ?>px;" data-trigger="fileinput">
										<img src="<?php echo base_url() . IMAGE_UPLOAD_PATH . $category['avatar'] ?>" alt="avatar">
									</div>
									<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 350px; max-height: <?php echo (int)(350 * PRODUCT_CATEGORY_IMAGE_HEIGHT / PRODUCT_CATEGORY_IMAGE_WIDTH) ?>px"></div>
									<div>
