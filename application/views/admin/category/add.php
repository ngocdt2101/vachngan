							...
							<div class="col-sm-12">
								<div class="fileinput fileinput-new" data-provides="fileinput">
									<div class="fileinput-new thumbnail" style="width: 350px; height: <?php echo (int)(350 * PRODUCT_CATEGORY_IMAGE_HEIGHT / PRODUCT_CATEGORY_IMAGE_WIDTH) ?>px;" data-trigger="fileinput">
										<img src="https://via.placeholder.com/350x<?php echo (int)(350 * PRODUCT_CATEGORY_IMAGE_HEIGHT / PRODUCT_CATEGORY_IMAGE_WIDTH) ?>" alt="...">
									</div>
		...
		methods: {
			save() {
				...
				if (validator) {
					...
					axios({
							method: 'POST',
							url: '<?php echo base_url() ?>admin/category/insert',
							headers: {
