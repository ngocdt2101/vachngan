<div>
	...
	<div class="action-admin" style="float: right;">
		<a class="btn btn-success" href="<?php echo base_url() ?>admin/quotation3/add">Thêm mới</a>
...
<div class="table-wrapper">
	<table id="posts-table" class="table table-bordered datatable">
		...
		<tbody>
			<?php foreach ($quotations3 as &$item) { ?>
				<tr data-id="<?php echo $item['id'] ?>">
					...
					<td style="vertical-align: middle;">
						<a href="<?php echo base_url() ?>admin/quotation3/edit/<?php echo $item['id'] ?>"><?php echo $item['name'] ?></a>
					</td>
					<td class="text-center" style="vertical-align: middle;">
					...
					<td class="text-center" style="vertical-align: middle;">
						<a class="btn btn-blue btn-sm" href="<?php echo base_url() ?>admin/quotation3/edit/<?php echo $item['id'] ?>">Xem</a>
...
<script type="text/javascript">
	...
	function updateDisplayOrder(el) {
		...
		axios({
				method: 'POST',
				url: '<?php echo base_url() ?>admin/quotation3/update_display_order',
				data: {
					id: id,
	...
	function updateStatus(el) {
		...
		axios({
				method: 'POST',
				url: '<?php echo base_url() ?>admin/quotation3/update_status',
				data: {
					id: $(el).data('id'),
					is_enable: is_enable
				}
	...
	function updateShowOnHome(el) {
		...
		axios({
				method: 'POST',
				url: '<?php echo base_url() ?>admin/quotation3/update_show_on_home',
				data: {
					id: $(el).data('id'),
	...
	function deletePost(el) {
		...
		axios({
				method: 'POST',
				url: '<?php echo base_url() ?>admin/quotation3/delete',
				data: {
					ids: selectedIds
				}
			})
