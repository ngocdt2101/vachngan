				...
				<div class="blog-post">
					<article>
						<div>
							...
							<span><i class="fa fa-bookmark-o"></i> <?php echo date("M", strtotime($news['updated_at'])) ?> <?php echo date("d", strtotime($news['updated_at'])) ?>, <?php echo date("Y", strtotime($news['updated_at'])) ?></span>
						</div>
				...
				<div class="shop-side-bar">
					...
					<div class="recent-post">
						<?php foreach ($related_news as $index => $item) { ?>
							<div class="media">
								<div class="media-left"> <a href="<?php echo base_url() . 'tin-tuc/' . $item['name_unsigned'] ?>"><img class="img-responsive" src="<?php echo base_url() . POST_UPLOAD_PATH . $item['avatar'] ?>" alt=""> </a> </div>
								<div class="media-body"> <a href="<?php echo base_url() . 'tin-tuc/' . $item['name_unsigned'] ?>"><?php echo $item['name'] ?></a> <span><?php echo date("M", strtotime($item['updated_at'])) ?> <?php echo date("d", strtotime($item['updated_at'])) ?>, <?php echo date("Y", strtotime($item['updated_at'])) ?> </span></div>
							</div>
						<?php } ?>
					</div>
				</div>
