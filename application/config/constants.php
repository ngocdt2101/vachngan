...
defined('ABOUT_IMAGE_WIDTH') OR define('ABOUT_IMAGE_WIDTH', 646);
defined('ABOUT_IMAGE_HEIGHT') OR define('ABOUT_IMAGE_HEIGHT', 486);
...
defined('POST_IMAGE_WIDTH') OR define('POST_IMAGE_WIDTH', 550);
defined('POST_IMAGE_HEIGHT') OR define('POST_IMAGE_HEIGHT', 371);
